...
from abaloneage.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig
from abaloneage.entity.config_entity import TrainingPipelineConfig
